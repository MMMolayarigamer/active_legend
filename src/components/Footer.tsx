...
import { Heart, Gamepad2, Send } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <form className="flex mb-4">
              ...
              <button
                type="submit"
                className="bg-primary text-dark-darker px-4 py-2 rounded-r-md hover:bg-primary-light transition-colors duration-300"
              >
